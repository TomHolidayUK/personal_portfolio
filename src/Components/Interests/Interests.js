...
//   <div className='running'>
//     <h2><b>Running</b></h2>
//     {/* <img src='https://tomholidaymyportfoliobucket.s3.eu-west-2.amazonaws.com/public//iCloudPhotos/Running/1.JPEG' alt="hello" loading="lazy"/>
//     <img src='https://tomholidaymyportfoliobucket.s3.eu-west-2.amazonaws.com/public//iCloudPhotos/Running/2.JPEG' alt="hello" loading="lazy"/>
//     <img src='https://tomholidaymyportfoliobucket.s3.eu-west-2.amazonaws.com/public//iCloudPhotos/Running/3.JPEG' alt="hello" loading="lazy"/> */}
//     <AutoScroll/>
//     <p>Formerly a road runner but recently I have been enjoying trail running much more.</p>
//     <p><b><u><a className="clickable-element underline" href="https://www.strava.com/athletes/55351253" target="_blank" rel="noopener noreferrer">Strava<HyperlinkLogo/></a></u></b></p>
//   </div>
...
//   <h2>Adventure</h2>
//   <div className='img-container'>
//     <img src='/iCloudPhotos/Travelling/1.jpg' alt="hello" loading="lazy"/>
//     <img src='/iCloudPhotos/Travelling/2.JPG' alt="hello" loading="lazy"/>
//     <img src='/iCloudPhotos/Travelling/3.jpg' alt="hello" loading="lazy"/>
//     <img src='/iCloudPhotos/Travelling/4.JPG' alt="hello" loading="lazy"/>
//     {/* <img src='/iCloudPhotos/Travelling/5.JPG' alt="hello" loading="lazy"/> */}
//     <img src='/iCloudPhotos/Travelling/6.JPG' alt="hello" loading="lazy"/>
//     <img src='/iCloudPhotos/Travelling/7.jpg' alt="hello" loading="lazy"/>
//     <img src='/iCloudPhotos/Travelling/8.JPG' alt="hello" loading="lazy"/>
//     <img src='/iCloudPhotos/Travelling/9.JPG' alt="hello" loading="lazy"/>
//     <img src='/iCloudPhotos/Other/4.JPEG' alt="hello" loading="lazy"/>
//     <img src='/iCloudPhotos/Other/5.JPG' alt="hello" loading="lazy"/>
//     </div>
//   </div>
//   <p>-----------------------------------------------</p>
//   <div className="film">
